# Generated by Django 4.0.3 on 2022-04-20 02:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('lsma', '0031_bookcheck_graphiccheck_sectioncheck_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='section',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='lsma.section', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='section',
            name='tn_priority',
